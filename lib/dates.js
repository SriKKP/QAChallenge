...
/**
* toDateTime function is not exported nor used in any other exported function.
* Added export function explicitly for it, for code coverage.
*/
exports.toDateTime = (dates)=>{
return toDateTime(dates);
}
/**
